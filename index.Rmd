...
LayeredFig <- function(keys, rug = TRUE, per_pop = FALSE) {
  ggplot(mapping = aes(x = time, y = value, group = key, color = key)) +
    ...
    {if(per_pop) scale_y_continuous(sec.axis = sec_axis(trans = ~ . / pop_outaouais_2020 * 100000, 
...
DailyFig <- function(keys, tab = "rls", rug = TRUE, per_pop = FALSE,
                     caption = "Data source: cisss-outaouais.gouv.qc.ca/language/en/covid19-en/") {
