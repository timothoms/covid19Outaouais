...
<!-- ## Cumulative cases, Outaouais & Ottawa (opencovid.ca) -->
```{r opencovid_total, eval = FALSE}
...
```{r rls_cumulative_gatineau, eval = FALSE}
LocalFig(df = rls[rls$key %in% c("Total cases (Outaouais)", "RLS de Grande-Rivière - Hull - Gatineau") & rls$table == "cases", ], 
       rug = FALSE, 
       note_last_day = FALSE,
       caption = "Data source: www.inspq.qc.ca/sites/default/files/covid/donnees/tableau-rls-new.csv")
```
```{r rls_cumulative_other, eval = FALSE}
LocalFig(df = rls[rls$key %in% c("RLS des Collines-de-l'Outaouais", "RLS du Pontiac", "RLS de la Vallée-de-la-Lièvre et de la Petite Nation", "RLS de la Vallée-de-la-Gatineau") & rls$table == "cases", ], 
       rug = FALSE, 
       note_last_day = FALSE,
       caption = "Data source: www.inspq.qc.ca/sites/default/files/covid/donnees/tableau-rls-new.csv")
```
...
```{r, child = 'md/table_glossary.md', eval = FALSE}
```

```{r, child = 'md/table_sources.md'}
```
