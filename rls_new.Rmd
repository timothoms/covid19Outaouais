...
```{r rls_avg_gatineau}
rls %>% 
  filter(table == "average" & key %in% c("Average increase per day (Outaouais)", 
...
```{r rls_avg_collines}
rls %>% 
  filter(table == "average" & key == "RLS des Collines-de-l'Outaouais") %>% 
  CovidFig(caption = "Data source: www.inspq.qc.ca/sites/default/files/covid/donnees/tableau-rls-new.csv")
```
...
```{r rls_avg_pontiac}
rls %>% 
  filter(table == "average" & key == "RLS du Pontiac") %>% 
  CovidFig(caption = "Data source: www.inspq.qc.ca/sites/default/files/covid/donnees/tableau-rls-new.csv")
```
...
```{r rls_avg_papineau}
rls %>% 
  filter(table == "average" & key == "RLS de la Vallée-de-la-Lièvre et de la Petite Nation") %>% 
  CovidFig(caption = "Data source: www.inspq.qc.ca/sites/default/files/covid/donnees/tableau-rls-new.csv")
```
...
```{r rls_avg_vallee}
rls %>% 
  filter(table == "average" & key == "RLS de la Vallée-de-la-Gatineau") %>% 
  CovidFig(caption = "Data source: www.inspq.qc.ca/sites/default/files/covid/donnees/tableau-rls-new.csv")
```
