...
keys <- list(
    ...
    list(c("Active cases", "Daily increase", "Deaths", "Average screening tests per day"), title = "Other key regional indicators"),
    list(c("Daily increase", "New cases (opencovid.ca)"), title = "Comparing CISSS and opencovid.ca")
)
...
```{r rls_new, echo = FALSE, results = 'hide', dpi = 225, fig.width = 7.5, fig.height = 5, out.width = "100%", out.height = "100%"}
keys <- list(
