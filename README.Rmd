...
keys <- list(
    list(c("Total", "RLS de Gatineau"), title = "Regional total & Gatineau"),
    list(c("RLS des Collines-de-l'Outaouais", "RLS de la Vallée-de-la-Gatineau", "RLS de Papineau", "RLS du Pontiac"), title = "")
)
lapply(keys, function(selection) {
