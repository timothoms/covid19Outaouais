...
keys <- list(
    cases = list(
        list(c("Cumulative cases", "Healed/resolved cases", "Total cases"), 
             title = "Total cases"),
        list(c("Active cases", "Daily increase", "Deaths", "Average screening test per day"), 
             title = "")
    ),
    rls = list(
        list(c("Total cases", "Total"), 
             title = "Total cases"),
        list(c("Active cases", "Total cases (active)", "Total (active)", "Healed/resolved cases", "To be determined"), 
             title = ""),
        list(c("RLS de Gatineau", "RLS de Gatineau (active)"), 
             title = "Gatineau"),
    ...
    areas = list(
        ...
        list(c(municipalities$municipality[municipalities$mrc == "La Vallée-de-la-Gatineau" & municipalities$designation == "Ville"], "Messines", "Déléage"), title = "MRC de la Vallée-de-la-Gatineau (Villes & Messines & Déléage)"),
        ...
        # list(municipalities$municipality[municipalities$mrc == "Hors MRC (autochtones)"], title = "Kitigan Zibi & Lac-Rapide" ),
        list(c("To be determined", "Active cases", "Healed/resolved cases"), title = "Other")
    )
)
```
...
```{r cases, echo=FALSE, results='hide', fig.width = 7.5, fig.height = 5, out.width = "100%", out.height = "100%"}
lapply(keys$cases, function(keys) {
    # list(
    ggplot(data = covid[covid$key %in% keys[[1]] & covid$table == "cases", ]) + 
...
```{r rls, echo=FALSE, results='hide', fig.width = 7.5, fig.height = 5, out.width = "100%", out.height = "100%"}
...
```{r areas, echo=FALSE, results='hide', fig.width = 7.5, fig.height = 5, out.width = "100%", out.height = "100%"}
