...
/usr/local/bin/Rscript -e 'Sys.setenv(RSTUDIO_PANDOC="/Applications/RStudio.app/Contents/MacOS/pandoc"); rmarkdown::render("index.Rmd", encoding = "UTF-8", params = list(optimize = TRUE))' >> ignore/render.log 2>&1
/usr/local/bin/Rscript -e 'Sys.setenv(RSTUDIO_PANDOC="/Applications/RStudio.app/Contents/MacOS/pandoc"); rmarkdown::render("toronto.Rmd", encoding = "UTF-8", params = list(optimize = TRUE))'
sleep 20
