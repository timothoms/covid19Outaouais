...
```{r opencovid_avg}
keys <- c("Average increase per day (Toronto)")
...
Last opencovid.ca API access: `r str_replace(read_file("data/api_access_time.txt"), "\n", "")`
