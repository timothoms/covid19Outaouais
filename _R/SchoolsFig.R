SchoolsFig <- function(admin) {
  ggplot(data = schools[schools$admin %in% admin, ]) + # mapping = aes(x = date, y = school)
    ...
    labs(x = "", y = "",
         caption = "Data source: www.quebec.ca/sante/problemes-de-sante/a-z/coronavirus-2019/liste-des-cas-de-covid-19-dans-les-ecoles/") +
    common_theme +
